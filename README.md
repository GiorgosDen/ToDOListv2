...
* [ ] **[TaskMaster Frontend](https://github.com/GiorgosDen/ToDoListv2FrontEnd)** — Built with **React.js, JavaScript (ES6+), and React Router** (Hosted on GitHub Pages).
* [ ] **[TaskMaster Backend](https://github.com/GiorgosDen/ToDOListv2BackEnd)** — Built with **Node.js, Express.js**, handling RESTful endpoints, authentication, and database connections.
